...
const App = () => {
  ...
  const addArtist = async () => {
    try {
      ...
      setArtistId(''); setName(''); setContactInfo(''); // Clear form after success
  ...
  const addProject = async () => {
    try {
      ...
      setProjectId(''); setTitle(''); setDescription(''); // Clear form after success
  ...
  const assignProject = async () => {
    try {
      ...
      setAssignArtistId(''); setAssignProjectId(''); // Clear form after success
    } catch (err) {
  ...
  return (
    <div>
      <div style={{ backgroundColor: "#28a745", padding: "20px", textAlign: "center" }}>
